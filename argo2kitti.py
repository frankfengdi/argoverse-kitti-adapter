...
'''
Official conversion from the paper "Train in Germany, Test in The USA: Making 3D Object Detectors Generalize", from Xiangyu Chen et al. CVPR2020
Codes provided by Xiangyu Chen by courtesy
...
def read_argoverse(argo_path):
    ...
    #data["test"] = extract_datapoints(os.path.join(argo_path, "test/"), test_set=False)
